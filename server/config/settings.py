"""
Django settings for procure-to-pay system.
"""
import os
...
ALLOWED_HOSTS = ["procure-to-pay-system.onrender.com", "localhost", "127.0.0.1"]
...
# Alternative: Use DATABASE_URL if provided (useful for Neon connection strings)
